...
export default function TradeAgingManager() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          {/* Featured Image */}
          <div className="mb-12">
            <img src="/blog/capital-trade-aging.webp" alt="Trade Aging Manager Strategy" className="w-full h-auto rounded-2xl" />
          </div>

          <div className="prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What is Trade Aging?</h2>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-6 space-y-2">
              <li><strong>Time stops:</strong> Exit if target not reached within X periods</li>
              <li><strong>Opportunity cost:</strong> Capital in stale trades can&apos;t find new opportunities</li>
              <li><strong>Thesis validation:</strong> Good trades usually work quickly</li>
              <li><strong>Reducing chop:</strong> Avoid death by a thousand cuts</li>
              <li><strong>Clean slate:</strong> Free up mental bandwidth</li>
            </ul>

            <h2 className="text-2xl font-bold text-gray-900 mb-4">Implementing Time Stops</h2>
            <p className="text-gray-600 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Graduated Time Management</h2>
            <p className="text-gray-600 mb-6">
            ...
            <div className="bg-green-50 border border-green-100 rounded-xl p-6 my-8">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Practice Trade Aging Risk-Free</h3>
              <p className="text-gray-600 mb-4">
                Learn to manage trade aging with paper trading before applying to real positions.
              </p>
